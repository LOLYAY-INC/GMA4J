...
/**
 * Draft whose inbound frame limit follows the connection instead of the static cap
 */
public final class FrameGuardedDraft extends Draft_6455 {
    private final IntSupplier limit;
    private final WebSocketFrameGuard guard;

    public FrameGuardedDraft(List<IExtension> extensions, List<IProtocol> protocols, int frameCap, IntSupplier limit) {
        super(extensions, protocols, frameCap);
        this.limit = limit;
        this.guard = new WebSocketFrameGuard(limit);
    }
